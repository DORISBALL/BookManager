<%@ page language="java" contentType="text/html; charset=utf-8" import=" com.gdut.model.*" import=" com.gdut.book.*" import ="java.util.ArrayList"
         pageEncoding="utf-8"%>
<%@ page import="com.gdut.model.BookLose" %>
